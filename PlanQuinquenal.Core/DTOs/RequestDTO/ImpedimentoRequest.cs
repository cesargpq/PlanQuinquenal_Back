...
{
    public class ImpedimentoRequest
    {
        ...
        List<Imped_evi_reempla> lstEviReempl_Inicial { get; set; }
        List<Imped_evi_reempla> lstEviReempl_Final { get; set; }
        List<Imped_gest_inast> lstGestInast_Inicial { get; set; }
        List<Imped_gest_inast> lstGestInast_Final { get; set; }
    }
}
